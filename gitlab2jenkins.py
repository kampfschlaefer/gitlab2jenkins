...
JENKINS_DESCTEMPLATE  = 'Automatically created job for branch <i>%(branch)s</i> of project <a href="%(uri)s">%(repo)s</a>.'
JENKINS_DESCTEMPLATE += ' Cloned from template <a href="/job/%(template)s">%(template)s</a>.\n\n'
JENKINS_DESCTEMPLATE += '<strong>Do not edit this job!</strong>\nInstead, <a href="/job/%(template)s/configure">'
JENKINS_DESCTEMPLATE += 'edit the template job</a>. Changes to the template will be propagated to all cloned jobs.'
